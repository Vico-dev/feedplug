...
export const dashboardNavigation: DashboardNavigationItem[] = [
  ...
  { nameKey: "channels", href: "/channels", icon: Radio, section: "workspace", description: "Connexion des destinations marketing (Google Merchant Center, Amazon, Google Ads, Bing)." },
