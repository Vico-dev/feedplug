    ...
    return (
      ...
      >
        <div style={{ maxWidth: '400px', width: '100%', margin: '0 auto', padding: '12px 0', textAlign: 'center' }}>
          ...
          <h1 style={{ fontSize: '22px', fontWeight: '600', color: 'var(--ink)', margin: '0 0 8px' }}>Email envoyé</h1>
          ...
          <Link href="/login" style={{ fontSize: '14px', color: 'var(--accent)', textDecoration: 'none', fontWeight: '500' }}>
  ...
  return (
    ...
    >
      <div style={{ maxWidth: '400px', width: '100%', margin: '0 auto' }}>
        <Link href="/login" style={{ display: 'flex', alignItems: 'center', gap: '6px', fontSize: '13px', color: 'var(--ink-3)', textDecoration: 'none', marginBottom: '24px' }}>
          <ArrowLeft style={{ width: '14px', height: '14px' }} /> Retour
        </Link>

        <h1 style={{ fontSize: '22px', fontWeight: '600', color: 'var(--ink)', margin: '0 0 8px' }}>Mot de passe oublié</h1>
        ...
        <form onSubmit={handleSubmit}>
          <div style={{ marginBottom: '16px' }}>
            <label style={{ display: 'block', fontSize: '13px', fontWeight: '500', color: 'var(--ink-2)', marginBottom: '6px' }}>Email</label>
            <div style={{ position: 'relative' }}>
              <Mail style={{ position: 'absolute', left: '12px', top: '50%', transform: 'translateY(-50%)', width: '18px', height: '18px', color: 'var(--ink-4)' }} />
              <input
                type="email"
                value={email}
          ...
          <button
            ...
            style={{
              ...
              backgroundColor: isLoading || !email ? 'var(--line-strong)' : 'var(--ink)',
