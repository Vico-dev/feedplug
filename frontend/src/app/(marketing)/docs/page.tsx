...
export default function DocsIndexPage() {
  return (
    <>
      ...
      >
        <div style={{ fontSize: 12, textTransform: "uppercase", letterSpacing: "0.14em", color: "var(--ink-4)", marginBottom: 10 }}>
          Vue d&apos;ensemble
        </div>
        <h1 style={{ fontSize: "2rem", fontWeight: 700, letterSpacing: "-0.04em", marginBottom: 8, color: "var(--ink)" }}>
          Documentation FeedPlug
        </h1>
        <p style={{ color: "var(--ink-2)", fontSize: "1.05rem", marginBottom: 16, lineHeight: 1.7 }}>
        ...
        <p style={{ color: "var(--ink-2)", fontSize: "1rem", marginBottom: 0, lineHeight: 1.7 }}>
      ...
      <p style={{ color: "var(--ink-2)", fontSize: 15, marginBottom: 24, lineHeight: 1.6 }}>
      ...
      <p style={{ color: "var(--ink-2)", fontSize: 15, marginBottom: 32, lineHeight: 1.6 }}>
        ...
        {docLinks.map(({ href, label, icon: Icon, description }) => (
          ...
          >
            ...
            <div style={{ flex: 1 }}>
              ...
              <div style={{ color: "var(--ink-3)", fontSize: 14 }}>{description}</div>
            </div>
            <ArrowRight size={18} style={{ flexShrink: 0, color: "var(--ink-3)" }} />
          </Link>
        ))}
      </div>
