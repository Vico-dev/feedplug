  ...
  return (
    <>
      ...
      <section style={{ marginBottom: 32 }}>
        ...
        <p style={{ margin: "0 0 16px", color: "#4a4a4a", fontSize: 15, lineHeight: 1.6 }}>
        ...
        <p style={{ margin: "0 0 24px", color: "#374151", fontSize: 15, lineHeight: 1.6 }}>
          <code style={{ background: "#f3f4f6", padding: "8px 12px", borderRadius: 6, display: "inline-block" }}>
            Score global = Conformité×30% + Qualité des données×30% + SEO×25% + Conversion×15%
          </code>
        </p>
        <p style={{ margin: "0 0 24px", color: "#4a4a4a", fontSize: 15, lineHeight: 1.6 }}>
        ...
        <p style={{ margin: "0 0 8px", color: "#4a4a4a", fontSize: 14, lineHeight: 1.6 }}>
        ...
        <ul style={{ margin: "0 0 8px", paddingLeft: 20, color: "#4a4a4a", fontSize: 14, lineHeight: 1.6 }}>
        ...
        <p style={{ margin: "0 0 0 8px", color: "#6b7280", fontSize: 13 }}>Conformité &lt; 70 = risque de rejet par Google.</p>
        ...
        <p style={{ margin: "24px 0 0", color: "#6b7280", fontSize: 14, lineHeight: 1.6 }}>
      ...
      <section style={{ marginBottom: 32, padding: 16, background: "#fef3c7", borderRadius: 8 }}>
        <h3 style={{ fontSize: "1rem", fontWeight: 600, marginBottom: 8, display: "flex", alignItems: "center", gap: 8, color: "#92400e" }}>
